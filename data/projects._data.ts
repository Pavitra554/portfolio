...
import iot_app from "../public/img/projects-preview/iot_app.png";
...
export const projects_data: projects_data_type[] = [
  {
    name: "IoT App",
    tags: ["Flutter", "Flask", "Dart", "Python", "Micropython"],
    description:
      "IoT-based Flutter application facilitating seamless interaction and control of connected devices.",
  ...
  },
  {
    ...
    description:
      "“Svaasthy” enables us to ease up the emergency medical situations by providing  the fastest way to reach your nearest hospitals.",
  ...
  },
  {
    ...
    description:
      "This is a weather app build with React Native. Which uses openweather API for weather data..",
