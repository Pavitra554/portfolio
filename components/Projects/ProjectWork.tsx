  ...
  return (
    <div className='font-noto w-full'>
      ...
      <Link href={'https://github.com/Pavitra554?tab=repositories'} target="_blank">
        <div className="w-44 tracking-wider mx-auto mt-6 bg-[#27272a] hover:bg-[#27272a]/40 p-1.5 rounded-md flex justify-center items-center  text-neutral-100 shadow-md select-none hover:brightness-125 active:scale-95 ease-linear duration-100 cursor-pointer">
          View More
        </div>
      </Link>
    </div>
