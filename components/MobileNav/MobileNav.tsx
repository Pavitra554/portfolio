      ...
      {value && (
        <>
          <motion.div
            ...
            className='h-screen w-full absolute bg-black/20 left-0 top-0 dark:bg-opacity-5 bg-opacity-20 backdrop-blur-sm'
          ></motion.div>
          <motion.div
            initial={{ x: -200, opacity: 0 }}
            animate={{ x: 0, opacity: 1 }}
            transition={{ duration: 0.3, delay: 0.2, type: "tween" }}
            className='h-screen w-[70%] absolute bg-neutral-100 dark:bg-black left-0 top-0 '
          >
