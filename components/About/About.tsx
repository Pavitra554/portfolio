...
const About = () => {
  return (
    <div className=''>
       ...
       <div className='bg-neutral-800/20 hover:brightness-125 p-3 md:p-4 rounded-lg text-neutral-400/70  text-noto text-base  md:text-lg tracking-wide  ease-linear duration-100'>
            <div className='pb-2'>
